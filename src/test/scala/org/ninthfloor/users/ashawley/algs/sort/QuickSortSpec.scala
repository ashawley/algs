/**
 * QuickSortSpec.scala --- Properties-based testing of quicksort
 *
...
import org.ninthfloor.users.ashawley.algs.sort.QuickSort
...
object QuickSortSpec extends Properties("QuickSort") with SortedProp {

  property("sort") = {
    forAll { a: List[Int] =>
      val r = QuickSort.sort(a)
      isSorted(r) :| "isSorted" &&
